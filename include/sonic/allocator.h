...
class SimpleChunkPolicy {
 public:
  ...
  SimpleChunkPolicy(const SimpleChunkPolicy& rhs) = default;
  SimpleChunkPolicy& operator=(const SimpleChunkPolicy& rhs) = default;

  SimpleChunkPolicy(SimpleChunkPolicy&& rhs) = default;
  SimpleChunkPolicy& operator=(SimpleChunkPolicy&& rhs) = default;
...
class AdaptiveChunkPolicy {
 public:
  ...
  AdaptiveChunkPolicy(const AdaptiveChunkPolicy& rhs) = default;
  AdaptiveChunkPolicy& operator=(const AdaptiveChunkPolicy& rhs) = default;

  AdaptiveChunkPolicy(AdaptiveChunkPolicy&& rhs) = default;
  AdaptiveChunkPolicy& operator=(AdaptiveChunkPolicy&& rhs) = default;
