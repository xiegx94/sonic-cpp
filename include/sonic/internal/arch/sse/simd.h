...
#if !__SSE__
#error "SSE instruction set required. Missing option -msse ?"
#endif
...
struct simd8x64 {
  ...
  simd8x64<T>& operator=(const simd128<T>& other) = delete; // no assignment allowed
  simd8x64() = delete; // no default constructor allowed

  sonic_force_inline simd8x64(const simd128<T> chunk0, const simd128<T> chunk1, const simd128<T> chunk2, const simd128<T> chunk3) : chunks{chunk0, chunk1, chunk2, chunk3} {}
  sonic_force_inline simd8x64(const T ptr[64]) : chunks{simd128<T>::load(ptr), simd128<T>::load(ptr+16), simd128<T>::load(ptr+32), simd128<T>::load(ptr+48)} {}
